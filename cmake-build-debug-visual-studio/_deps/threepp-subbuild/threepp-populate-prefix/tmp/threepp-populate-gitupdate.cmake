...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "619cdaacc2e7dc6ea709d8c7f482e2994af7349d"
  WORKING_DIRECTORY "C:/dev/flappy_demo/cmake-build-debug-visual-studio/_deps/threepp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/dev/flappy_demo/cmake-build-debug-visual-studio/_deps/threepp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/dev/flappy_demo/cmake-build-debug-visual-studio/_deps/threepp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
